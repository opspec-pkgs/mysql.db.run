[![Build Status](https://github.com/opspec-pkgs/mysql.db.run/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/mysql.db.run/actions?query=workflow%3Abuild+branch%3Amain)
