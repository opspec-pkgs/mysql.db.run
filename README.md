[![build](https://github.com/opspec-pkgs/mysql.db.run/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/mysql.db.run/actions/workflows/build.yml)
